...
<html>
	...
	<title>SCHOLARLY &mdash; High School Content</title>
	...
	<nav class="fh5co-nav" role="navigation">
		...
		<div class="top-menu">
			<div class="container">
				<div class="row">
					<div class="col-xs-2">
						<div id="fh5co-logo"><a href="index.html"><i class="icon-study"></i>Scholarly<span>.</span></a></div>
					</div>
					<div class="col-xs-10 text-right menu-1">
						<ul>
							...
							<li class="has-dropdown">
								...
								<ul class="dropdown">
									<li><a href="login.php">Web Design</a></li>
									<li><a href="login.php#">eCommerce</a></li>
									<li><a href="login.php">Branding</a></li>
		   		...
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
							   ...
							   <h1><strong>SCHOLARLY</strong></h1>
			   					<h1><p>Kenya's digitized curriculum content.</p>
                                    <p>Affordable. Accessible. Everywhere.</p></h1>
									
									<p><a class="btn btn-primary btn-lg" href="login.php">Start Learning Now!</a></p>
			   				</div>
			   			</div>
			   		</div>
		   		</div>
			   			...
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
							   ...
							   <h1><strong>SCHOLARLY</strong></h1>
			   					<h1>The Great Aim of Education is not Knowledge, But Action</h1>
									...
									<p><a class="btn btn-primary btn-lg btn-learn" href="login.php">Start Learning Now!</a></p>
			   				</div>
			   			</div>
			   		</div>
		   		</div>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					...
					<p>Get all the power of digital technology to work for you and the ones that you care about and map a learning experience that works in the future, right now.</p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							...
							<p>Category Includes Mathematics</p>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							<h3><a href="#">Sciences &amp; Health</a></h3>
							<p>Category Includes Biology</p>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							...
							<p>Category Includes Business Studies and Agriculture</p>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							...
							<p>Category Includes Physics and Chemistry</p>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							<h3><a href="#">Art &amp; Music</a></h3>
							<p>Category Includes Art and Design and Music</p>
						</div>
					</div>
				</div>
				...
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							...
							<p>Category Includes English, Kiswahili, French and Germany</p>
						</div>
					</div>
				</div>
               ...
               <div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							<h3><a href="#">Humanities</a></h3>
							<p>Category Includes Geography, History and Religious Education</p>
						</div>
					</div>
				</div>
				...
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							<h3><a href="#">Computing &amp; Programming</a></h3>
							<p>Category includes Computer Studies</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					...
					<p>This is a preview of subjects we offer</p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							<h3><a href="#">Mathematics</a></h3>
							<p>Preview contents of this subject</p>
							<span><a href="#" class="btn btn-primary btn-sm btn-course">Preview</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2 animate-box">
				<div class="date-counter text-center">
					<h2>Get 80 of Online Courses for Free</h2>
					<div class="simply-countdown simply-countdown-one"></div>
					<p><strong>Limited Offer!</strong></p>
					<p><a href="signup.php" class="btn btn-primary btn-lg btn-reg">Register Now!</a></p>
				</div>
			</div>
		</div>
	</div>
